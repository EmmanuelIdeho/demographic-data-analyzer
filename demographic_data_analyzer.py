...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(percentage_bachelors, 1)  # Round the result to the nearest tenth
    ...
    # Identify the country with the highest percentage and its percentage value
