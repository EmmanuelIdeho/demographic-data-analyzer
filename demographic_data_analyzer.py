...
def calculate_demographic_data(print_data=True):
    ...
    num_min_workers = min_work_hours[min_work_hours['salary'] == '>50k']

    rich_percentage = (num_min_workers.shape[0] / min_work_hours.shape[0]) * 100

    # What country has the highest percentage of people that earn >50K?
    highest_earning_country = df[df['native-country']]
